...
class BannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validate = Validator::make(
            ...
            [
                ...
                'image_part1' => 'required|file|mimes:jpg,jpeg,png,gif|max:10240',
                'image_part2' => 'required|file|mimes:jpg,jpeg,png,gif|max:10240',
                'image_part3' => 'required|file|mimes:jpg,jpeg,png,gif|max:10240',
    ...
    public function update(Request $request, $id)
    {
        ...
        $validate = Validator::make(
            ...
            [
                ...
                'image_part1' => 'nullable|file|mimes:jpg,jpeg,png,gif|max:10240',
                'image_part2' => 'nullable|file|mimes:jpg,jpeg,png,gif|max:10240',
                'image_part3' => 'nullable|file|mimes:jpg,jpeg,png,gif|max:10240',
                'position' => 'required|in:1,2',
            ]
        );
        $json = new stdClass();
        ...
        try {
            ...
            if ($request->image_part1) {

                if ($object->image_part1) {
                    FileHelper::forceDeleteFiles($object->image_part1->id, $object->id, ThisModel::class, 'image_part1');
                }

                FileHelper::uploadFile($request->image_part1, 'banners', $object->id, ThisModel::class, 'image_part1', 99);
            }

            if ($request->image_part2) {

                if ($object->image_part2) {
                    FileHelper::forceDeleteFiles($object->image_part2->id, $object->id, ThisModel::class, 'image_part2');
                }

                FileHelper::uploadFile($request->image_part2, 'banners', $object->id, ThisModel::class, 'image_part2', 99);
            }

            if ($request->image_part3) {

                if ($object->image_part3) {
                    FileHelper::forceDeleteFiles($object->image_part3->id, $object->id, ThisModel::class, 'image_part3');
                }

                FileHelper::uploadFile($request->image_part3, 'banners', $object->id, ThisModel::class, 'image_part3', 99);
            }
    ...
    public function delete($id)
    {
        ...
        if (!$object->canDelete()) {
            ...
            if (isset($object->image_part1)) {
                FileHelper::forceDeleteFiles($object->image_part1->id, $object->id, ThisModel::class, 'image_part1');
            }
            if (isset($object->image_part2)) {
                FileHelper::forceDeleteFiles($object->image_part2->id, $object->id, ThisModel::class, 'image_part2');
            }
            if (isset($object->image_part3)) {
                FileHelper::forceDeleteFiles($object->image_part3->id, $object->id, ThisModel::class, 'image_part3');
            }
            $object->delete();
            $message = array(
