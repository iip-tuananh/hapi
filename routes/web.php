...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::middleware('auth:admin')->group(function () {
        ...
        Route::group(['prefix' => 'questions'], function () {
            ...
            Route::get('/searchData', 'Admin\QuestionController@searchData')->name('Question.searchData');
            Route::get('/{id}/show', 'Admin\QuestionController@show')->name('Question.show');
            Route::get('/create', 'Admin\QuestionController@create')->name('Question.create');
            Route::post('/', 'Admin\QuestionController@store')->name('Question.store');
            Route::post('/{id}/update', 'Admin\QuestionController@update')->name('Question.update');
            Route::get('/{id}/delete', 'Admin\QuestionController@delete')->name('Question.delete');
            Route::get('/{id}/getDataForEdit', 'Admin\QuestionController@getDataForEdit');
            Route::get('/exportExcel', 'Admin\QuestionController@exportExcel')->name('Question.exportExcel');
        });
